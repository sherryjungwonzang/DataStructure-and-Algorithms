...
//back to dfs(11, 19) -> 11 <= 13
//res = [ 1, 10, 11, ]
//dfs(11 * 10, 11 * 10 + 9) = dfs(110, 119) -> break

//back to dfs(12, 19) -> 12 <= 13
//res = [ 1, 10, 11, 12, ]
//dfs(12 * 10, 12 * 10 + 9) = dfs(120, 129) -> break

//back to dfs(13, 19) -> 11 <= 13
//res = [ 1, 10, 11, 12, 13, ]
//dfs(13 * 10, 13 * 10 + 9) = dfs(130, 139) -> break
