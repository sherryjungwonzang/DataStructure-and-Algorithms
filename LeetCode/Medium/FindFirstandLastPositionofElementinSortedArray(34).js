...
var findFirstAndLast = (nums, target) => {
  ...
  while(left <= right) {
    ...
    //need to check the leftBound is equal to target or not
  ...
  //need to look for the right bound element
  //should reset the left and right - we have carried out binary search to look for the left bound
  left = 0;
  right = nums.length - 1;
