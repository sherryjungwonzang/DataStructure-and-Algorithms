...
var removeDuplicates = (s) => {
  ...
  for (let char of s) {
    //if they are equal -> add to stack
    //if not then pop off from the stack
    stack[stack.length - 1] === char ? stack.pop() : stack.push(char);
  }
  //convert it from array format to string format
  return stack.join("");
}
...
removeDuplicates("abbaca"); //"ca" - can remove "bb" since the letters are adjacent and equal, and then possible move. After moving, "aa" is possible to remove
//stack = [ ]
//"a b b a c a"
// ^
