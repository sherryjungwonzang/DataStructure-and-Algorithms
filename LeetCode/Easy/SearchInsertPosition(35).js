...
//Approach:
//using Binary Search with comparing mid and target value
var searchIntertPosition = (nums, target) => {
  let left = 0;
...
searchIntertPosition([1,3,5,6], 5); //2
//[1, 3, 5, 6], target = 5
// l  m     r
...
searchIntertPosition([1,3,5,6], 2); //1
//[1, 3, 5, 6], target = 2
// l  m     r
...
searchIntertPosition([1,3,5,6], 7); //4
//[1, 3, 5, 6], target = 7
// l  m     r
