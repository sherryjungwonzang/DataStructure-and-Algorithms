...
//int get(int key) returns the value to which the specified key is maped, or -1 if this map contains no mapping for the key
...
MyHashMap.prototype.remove = (key) => {
    //delete: to remove the object prop
    delete this.map[key];
};
