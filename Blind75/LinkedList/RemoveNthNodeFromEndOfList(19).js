...
//Approach:
//reassigning the previous node of delete to the next.next node
//using two pointers: left and right - to find the previous node of delete node
var removeNthNodefromEnd = (head, n) => {
  ...
  //move bothe left and right pointer
