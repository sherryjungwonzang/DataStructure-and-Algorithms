...
var productArrayExceptSelf = (nums) => {
  let forwardArr = [];
  let start = 1; //placeholder for forwards array
  ...
  let res = [];
  let start2 = 1; //placeholder for backwards array

  for (let i = nums.length - 1; i >= 0; i--) {
    res.unshift(start2 * forwardArr[i]); //need to add from the backwards - using unshift()
...
//forwardArr = [1, 1, ] - 1 * 1
//forwardArr = [1, 1, 2, ] - 1 * 2
//forwardArr = [1, 1, 2, 6] - 2 * 3

//res = [ ,6] - 6 * 1 | start2=1
//res = [  ,8 ,6] - 4 * 2 | start2 = 1 * 4 = 4
//res = [ ,12 ,8 ,6] - 12 * 1 | start2 = 4 * 3 = 12
